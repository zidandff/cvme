        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header d-block text-center">
                    <h5 class="modal-title" id="exampleModalLabel">Buat CV Baru</h5>
                </div>
                <div class="modal-body">
                    <form action="/create/resume" method="POST">
                        ...
                        <div class="form-floating mb-3 col-md-8 col-lg-6 mx-auto">
                            <input type="text" name="title" class="form-control" id="floating-title" placeholder="Judul Resume" required>
                            <label for="floating-title">Judul Resume</label>
                        </div>
                        <h3 class="text-center my-2">Pilih Tema</h3>
                        {{-- Choose Theme --}}
                        <div class="d-flex">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="submit" class="btn btn-custom-secondary px-4">Buat Baru</button>
                </div>
                </form>
            </div>
        </div>
